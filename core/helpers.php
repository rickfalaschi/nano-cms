...
if (!function_exists('image_url')) {
     ...
     *   - null/empty → ''
     *
     * The $size parameter is kept for backward compatibility with themes
     * that pass a variant name. Image variants are not generated by this
     * engine — every call returns the URL of the original file. The
